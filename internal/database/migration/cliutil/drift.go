...
func Drift(commandName string, factory RunnerFactory, outFactory OutputFactory, expectedSchemaFactories ...schemas.ExpectedSchemaFactory) *cli.Command {
	...
	action := makeAction(outFactory, func(ctx context.Context, cmd *cli.Context, out *output.Output) error {
		...
		return drift.CompareAndDisplaySchemaDescriptions(out, schemaName, version, multiversion.Canonicalize(schema), multiversion.Canonicalize(expectedSchema))
	})
